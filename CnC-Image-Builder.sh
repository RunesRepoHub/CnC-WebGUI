...
do
    case $opt in
        "Local")
           docker build -t cnc-web:$versionweb /root/CnC-WebGUI/CnC-WebGUI/Nginx-Docker

           docker build -t cnc-mysql:$versiondb /root/CnC-WebGUI/CnC-WebGUI/MySQL-Docker

           docker-compose -f /root/CnC-WebGUI/CnC-WebGUI/docker-compose.yaml -p CnC-WebGUI down -v 
